...
<table width="700" border="0" cellspacing="1" cellpadding="3">
  ...
  <tr>
    ...
    Jumlah : 
        <input class="angkaC" name="txtJumlah" size="6" maxlength="4" value="10" 
...
<table width="700" border="0" cellspacing="1" cellpadding="3">
  ...
  <tr>
    ...
    <td width="310" bgcolor="#CCCCCC"><strong>Nama Barang </strong></td>
    <td width="80" bgcolor="#CCCCCC"><strong>Harga (Rp) </strong></td>
    <td width="48" bgcolor="#CCCCCC"><strong>Jumlah</strong></td>
    <td width="99" bgcolor="#CCCCCC"><strong>Subtotal(Rp) </strong></td>
    <td width="34"><strong>Tools</strong></td>
  </tr>
	<?php
	// deklarasi variabel
	$hargaDiskon= 0; 
  ...
  <tr>
    ...
    <td> <?php echo format_angka($tmpData['harga']); ?> </td>
    <td> <?php echo format_angka($tmpData['jumlah']); ?> </td>
    <td> <?php echo format_angka($subSotal); ?> </td>
  ...
  <tr>
    ...
    <td> <b><?php echo format_angka($jumlahbarang); ?></b> </td>
    <td> <b><?php echo format_angka($totalBayar); ?></b> </td>
    <td>&nbsp;</td>
  </tr>
</table>
</form>
