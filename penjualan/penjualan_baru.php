...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  ...
  <table width="700" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td width="27%"><strong>No. Penjualan </strong></td>
    ...
    <tr>
      ...
      <td><b>:</b></td>
      <td><input name="txtUangBayar" size="20" maxlength="12"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
  ...
  <table width="700" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      ...
      <td width="291" bgcolor="#CCCCCC"><strong>Nama Barang </strong></td>
      ...
      <td width="44"><strong>Tools</strong></td>
    </tr>
	<?php
	// deklarasi variabel
	$hargaDiskon= 0; 
    ...
    <tr>
      ...
      <td bgcolor="#F5F5F5"><b><?php echo $jumlahbarang; ?></b></td>
      <td bgcolor="#F5F5F5"><b><?php echo format_angka($totalBayar); ?></b></td>
      <td><input name="txtTotBayar" type="hidden" value="<?php echo $totalBayar; ?>" /></td>
    </tr>
  </table>
</form>
</body>
