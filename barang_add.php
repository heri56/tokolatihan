...
if(isset($_POST['btnSimpan'])){
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "INSERT INTO barang (kd_barang, nm_barang, harga_beli, harga_jual, stok, satuan, keterangan, kd_kategori) 
						VALUES ('$kodeBaru',
								'$txtNama',
								'$txtHargaBeli',
								'$txtHargaJual',
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="650" border="0" cellspacing="1" cellpadding="3">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><strong>TAMBAH DATA BARANG </strong></td>
    </tr>
    <tr>
      <td width="25%"><strong>Kode</strong></td>
      <td width="2%"><strong>:</strong></td>
      <td width="73%"><input name="textfield" value="<?php echo $dataKode; ?>" size="14" maxlength="10" readonly="readonly"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="txtStok" value="<?php echo $dataStok; ?>" size="14" maxlength="4" 
	  			onblur="if (value == '') {value = '0'}" 
				onfocus="if (value == '0') {value =''}"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="txtKeterangan" value="<?php echo $dataKeterangan; ?>" size="70" maxlength="200" /></td>
    </tr>
    <tr>
